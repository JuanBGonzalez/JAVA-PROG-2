package Arabeunido;
/* 
 * Usted fue contratado por el Deportivo Árabe Unido para que desarrolle la primera fase de un proyecto en Java donde se simule todas las  
 *  actividades a ejecutarse antes, durante y luego de un partido de fútbol. 

Este proyecto constará del paquete arabeunido, que está conformado por una interfaz (Integrante), una clase abstracta (Equipo) y 
...
Para validar que el diagrama de clases para este proyecto esté bien diseñado, el punto de contacto en el Deportivo Árabe Unido le 
